        ...
        <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row justify-between">
            <span class="flex w-full rounded-md shadow-sm sm:w-auto">
                <button wire:click="showDeleteModal"
                    class="inline-flex justify-center w-full rounded-full border border-transparent px-4 py-2 bg-red-600 text-base leading-6 font-medium text-white shadow-sm hover:bg-red-500 focus:outline-none focus:border-red-700 focus:shadow-outline-red transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                    Excluir conta
                </button>
            </span>
            <span class="flex w-full rounded-md shadow-sm sm:w-auto">
